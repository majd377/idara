...
- Subscriber table includes phone number.
...
## صفحة مستقلة: صندوق العمارة والإيرادات
تمت إضافة `fund.html` كصفحة مستقلة عن حسبة المياه. تشمل خدمة الحارس، استلام وبيع السولار، صندوق العمارة، الإيرادات الأخرى، والتقرير الشهري. لا تغيّر هذه الصفحة معادلات المياه أو حسابات السكان.

### صندوق العمارة والإيرادات
صفحة مستقلة `fund.html` لإدارة خدمات الحارس شهريًا، استلام وبيع السولار، صندوق العمارة، الإيرادات الأخرى والتقارير الشهرية. هذه الوحدة لا تدخل في حسبة المياه.
