...
## V18 final changes
- Contributions/discounts moved to a dedicated collection/page and reduce water operating cost.
- Debt, payment, cost, contribution, reading, energy-reading deletion actions added where permitted.
- Embedded historical periods are limited to 03/09/2026 only.
- Payment records are linked to the current selected billing period when recorded.
- Resident message calculates prior balance + current charges - current-period payments, and includes current water consumption.
