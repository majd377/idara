const CACHE='amin-building-v41';
const CORE=['./','./index.html','./app-v31.js?v=41.0','./styles-v31.css?v=41.0','./initial-data.js','./firebase-config.js','./firebase-init-v31.js','./manifest.webmanifest?v=41.0','./icons/icon-192.png','./icons/icon-512.png'];
