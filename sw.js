const CACHE='amin-building-v45';
const CORE=['./','./index.html','./app-v31.js?v=45.0','./styles-v31.css?v=45.0','./initial-data.js','./firebase-config.js','./firebase-init-v31.js','./manifest.webmanifest?v=45.0','./icons/icon-192.png','./icons/icon-512.png'];
