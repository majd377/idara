const CACHE='amin-building-v44-1';
const CORE=['./','./index.html','./app-v31.js?v=44.1','./styles-v31.css?v=44.1','./initial-data.js','./firebase-config.js','./firebase-init-v31.js','./manifest.webmanifest?v=44.1','./icons/icon-192.png','./icons/icon-512.png'];
