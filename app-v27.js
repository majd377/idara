...
$('#googleLogin')?.addEventListener('click',async()=>{const b=$('#auth-error');b.classList.add('hidden');try{await signInWithRedirect(auth,provider)}catch(e){console.error(e);b.textContent=authFriendlyError(e)||e?.message||'تعذر تسجيل الدخول';b.classList.remove('hidden');}});
